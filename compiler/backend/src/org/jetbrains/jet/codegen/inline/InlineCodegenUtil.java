...
public class InlineCodegenUtil {
    ...
    public static boolean isGoToTryCatchBlockEnd(@NotNull AbstractInsnNode node) {
        return node.getOpcode() == Opcodes.GOTO &&
               ...
               INLINE_MARKER_CLASS_NAME.equals(((MethodInsnNode) node.getPrevious()).owner) &&
               INLINE_MARKER_GOTO_TRY_CATCH_BLOCK_END.equals(((MethodInsnNode) node.getPrevious()).name);
    }
