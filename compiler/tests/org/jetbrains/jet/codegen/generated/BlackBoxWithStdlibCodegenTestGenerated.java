...
public class BlackBoxWithStdlibCodegenTestGenerated extends AbstractBlackBoxCodegenTest {
    ...
    @TestMetadata("compiler/testData/codegen/boxWithStdlib/variablesOptimization")
    @TestDataPath("$PROJECT_ROOT")
    @RunWith(JUnit3RunnerWithInners.class)
    public static class VariablesOptimization extends AbstractBlackBoxCodegenTest {
        public void testAllFilesPresentInVariablesOptimization() throws Exception {
            JetTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("compiler/testData/codegen/boxWithStdlib/variablesOptimization"), Pattern.compile("^(.+)\\.kt$"), true);
        }

        @TestMetadata("inline.kt")
        public void testInline() throws Exception {
            String fileName = JetTestUtils.navigationMetadata("compiler/testData/codegen/boxWithStdlib/variablesOptimization/inline.kt");
            doTestWithStdlib(fileName);
        }

        @TestMetadata("inlineStdlib.kt")
        public void testInlineStdlib() throws Exception {
            String fileName = JetTestUtils.navigationMetadata("compiler/testData/codegen/boxWithStdlib/variablesOptimization/inlineStdlib.kt");
            doTestWithStdlib(fileName);
        }

        @TestMetadata("simple.kt")
        public void testSimple() throws Exception {
            String fileName = JetTestUtils.navigationMetadata("compiler/testData/codegen/boxWithStdlib/variablesOptimization/simple.kt");
            doTestWithStdlib(fileName);
        }
    }
